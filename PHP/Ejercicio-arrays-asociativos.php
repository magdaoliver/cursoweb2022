...
$profesor['apellido'] = 'Esteve García';  // Si queremos llegar a 'Esteve', le daremos la clave 'apellido'

$profesor['ciudad'] = 'Torrelles de Foix';  // Aquí le asignamos nuevo valor a la clave 'ciudad'
// Ejercicio 2 tablon: El teléfono 665533 es de Marc que vive en Torrelles de Foix.
